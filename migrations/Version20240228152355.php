 ...
 */
final class Version20240228152355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE xapi_attachment (`usage_type` VARCHAR(255) NOT NULL, `content_type` VARCHAR(255) NOT NULL, `length` INT NOT NULL, `sha2` VARCHAR(255) NOT NULL, `display` JSON NOT NULL, `has_description` TINYINT(1) NOT NULL, `description` JSON DEFAULT NULL, `file_url` VARCHAR(255) DEFAULT NULL, `content` LONGTEXT DEFAULT NULL, `identifier` INT AUTO_INCREMENT NOT NULL, `statement_id` VARCHAR(255) DEFAULT NULL, INDEX IDX_7148C9A1319F2A73 (`statement_id`), PRIMARY KEY(`identifier`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE xapi_context (`registration` VARCHAR(255) DEFAULT NULL, `has_context_activities` TINYINT(1) DEFAULT NULL, `revision` VARCHAR(255) DEFAULT NULL, `platform` VARCHAR(255) DEFAULT NULL, `language` VARCHAR(255) DEFAULT NULL, `statement` VARCHAR(255) DEFAULT NULL, `identifier` INT AUTO_INCREMENT NOT NULL, `instructor_id` INT DEFAULT NULL, `team_id` INT DEFAULT NULL, `extensions_id` INT DEFAULT NULL, UNIQUE INDEX UNIQ_3D777190B26C3C29 (`instructor_id`), UNIQUE INDEX UNIQ_3D77719071BF2681 (`team_id`), UNIQUE INDEX UNIQ_3D777190DB361082 (`extensions_id`), PRIMARY KEY(`identifier`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE xapi_extensions (`extensions` JSON NOT NULL, `identifier` INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(`identifier`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE xapi_object (`type` VARCHAR(255) DEFAULT NULL, `activity_id` VARCHAR(255) DEFAULT NULL, `has_activity_definition` TINYINT(1) DEFAULT NULL, `has_activity_name` TINYINT(1) DEFAULT NULL, `activity_name` JSON DEFAULT NULL, `has_activity_description` TINYINT(1) DEFAULT NULL, `activity_description` JSON DEFAULT NULL, `activity_type` VARCHAR(255) DEFAULT NULL, `activity_more_info` VARCHAR(255) DEFAULT NULL, `mbox` VARCHAR(255) DEFAULT NULL, `mbox_sha1_sum` VARCHAR(255) DEFAULT NULL, `open_id` VARCHAR(255) DEFAULT NULL, `account_name` VARCHAR(255) DEFAULT NULL, `account_home_page` VARCHAR(255) DEFAULT NULL, `name` VARCHAR(255) DEFAULT NULL, `referenced_statement_id` VARCHAR(255) DEFAULT NULL, `identifier` INT AUTO_INCREMENT NOT NULL, `actor_id` INT DEFAULT NULL, `object_id` INT DEFAULT NULL, `activity_extensions_id` INT DEFAULT NULL, `verb_id` INT DEFAULT NULL, `group_id` INT DEFAULT NULL, `parent_context_id` INT DEFAULT NULL, `grouping_context_id` INT DEFAULT NULL, `category_context_id` INT DEFAULT NULL, `other_context_id` INT DEFAULT NULL, UNIQUE INDEX UNIQ_E2B68640DDCD8401 (`actor_id`), UNIQUE INDEX UNIQ_E2B68640EBF61561 (`object_id`), UNIQUE INDEX UNIQ_E2B68640A03118A (`activity_extensions_id`), INDEX IDX_E2B686403488C618 (`verb_id`), INDEX IDX_E2B68640A3927697 (`group_id`), INDEX IDX_E2B6864029B3DF5B (`parent_context_id`), INDEX IDX_E2B68640F3DD0B2 (`grouping_context_id`), INDEX IDX_E2B68640E632571 (`category_context_id`), INDEX IDX_E2B68640D0E91813 (`other_context_id`), INDEX uniq_search_index (activity_id, activity_type), PRIMARY KEY(`identifier`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE xapi_result (`has_score` TINYINT(1) NOT NULL, `scaled` DOUBLE PRECISION DEFAULT NULL, `raw` DOUBLE PRECISION DEFAULT NULL, `min` DOUBLE PRECISION DEFAULT NULL, `max` DOUBLE PRECISION DEFAULT NULL, `success` TINYINT(1) DEFAULT NULL, `completion` TINYINT(1) DEFAULT NULL, `response` VARCHAR(255) DEFAULT NULL, `duration` VARCHAR(255) DEFAULT NULL, `identifier` INT AUTO_INCREMENT NOT NULL, `extensions_id` INT DEFAULT NULL, UNIQUE INDEX UNIQ_5971ECBFDB361082 (`extensions_id`), PRIMARY KEY(`identifier`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE xapi_state (`registration_id` VARCHAR(255) NOT NULL, `data` LONGTEXT DEFAULT NULL, `activity_id` VARCHAR(255) NOT NULL, `state_id` VARCHAR(255) NOT NULL, `actor_id` INT DEFAULT NULL, INDEX IDX_671B3F9FDDCD8401 (`actor_id`), PRIMARY KEY(`activity_id`, `state_id`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE xapi_statement (`created` DATETIME DEFAULT NULL, `stored` DATETIME DEFAULT NULL, `has_attachments` TINYINT(1) NOT NULL, `id` VARCHAR(255) NOT NULL, `result_id` INT DEFAULT NULL, `actor_id` INT DEFAULT NULL, `verb_id` INT DEFAULT NULL, `object_id` INT DEFAULT NULL, `authority_id` INT DEFAULT NULL, `context_id` INT DEFAULT NULL, UNIQUE INDEX UNIQ_BAF6663BA8BB76EB (`result_id`), INDEX IDX_BAF6663BDDCD8401 (`actor_id`), INDEX IDX_BAF6663B3488C618 (`verb_id`), INDEX IDX_BAF6663BEBF61561 (`object_id`), INDEX IDX_BAF6663B319A5A43 (`authority_id`), INDEX IDX_BAF6663BAC004ABE (`context_id`), PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE xapi_verb (`id` VARCHAR(255) NOT NULL, `display` JSON NOT NULL, `identifier` INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(`identifier`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
